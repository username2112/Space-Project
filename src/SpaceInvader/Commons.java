...
public interface Commons {
	...
	/*
	 * player: 32 x 32 player shot: 8 x 8 boss: 128 x 128 boss shot: 16 x 16 alien:
	 * 32 x 32 alien bomb: 16 x 16 bossBomb/missile: 16 x 16
	 * 
	 * all audio must be in .wav format all images must be .png with no background
	 */
